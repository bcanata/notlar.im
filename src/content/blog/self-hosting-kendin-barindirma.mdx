...
tags:
  - internet
description: >-
  Self Hosting nedir? Docker kullanmayı kolaylaştıran Caprover nasıl kullanılır?
  Nasıl kurulur? Neler yüklenir?
...
> Burada bir dipnot da düşeyim. Self hosting ile alakalı bilgi almak, gelişmeleri takip etmek için GitHub üzerinden, [selfhosted etiketi taşıyan paketleri](https://github.com/topics/selfhosted) ve Reddit'ten [r/selfhosted](https://www.reddit.com/r/selfhosted/) kanalını takip edebilirsiniz.
...
![](https://i.imgur.com/p6wK6KM.png)archivebox arayüzü
...
![](https://raw.githubusercontent.com/amir20/dozzle/master/docs/.vitepress/theme/media/poster-light.png)dozzle kullanıcı arayüzü
